...
const lodashEs = {
  ...
  filtrar: (array: any[], predicado: (valor: any) => boolean) =>
    _.filter(array, predicado), // _.filter
  mapear: (array: any[], transformacion: (valor: any) => any) =>
    _.map(array, transformacion), // _.map
  reducir: (
    array: any[],
    acumulador: (acum: any, val: any) => any,
    inicial?: any
  ) => _.reduce(array, acumulador, inicial), // _.reduce
  encontrar: (array: any[], predicado: (valor: any) => boolean) =>
    _.find(array, predicado), // _.find
  ordenar: (array: any[], clave: string | string[]) =>
    _.orderBy(array, [clave]), // _.orderBy
  ...
  reemplazar: (texto: string, buscar: string, reemplazo: string) =>
    _.replace(texto, buscar, reemplazo), // _.replace
